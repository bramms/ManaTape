...
Відкрийте **http://127.0.0.1:19421/**. Поки репозиторій приватний, клонування потребує доступу GitHub. Для ознайомлення без OMP і без справжніх облікових записів: `make demo` → http://127.0.0.1:19424/.
...
Репозиторій наразі приватний. Ліцензію основного проєкту ще не обрано; публікація коду сама по собі не надає дозволу на його поширення. Включений компонент OpenCode Free має власну [MIT-ліцензію](integrations/opencode-free/LICENSE). Перед публічним випуском потрібно визначити ліцензію основного проєкту.
