...
![Mana Tape — світлий монтажний пульт на синтетичних даних](docs/assets/desktop-light.jpg)

*Один прилад: LCD показують ресурс, ручки змінюють пріоритет, CUTS складаються в доріжки. На знімках — лише синтетичні демонстраційні дані.*

<details>
<summary>Темна тема й редагування пулів на телефоні</summary>

![Темна тема Mana Tape](docs/assets/desktop-dark.jpg)

<img src="docs/assets/mobile-pools.jpg" width="390" alt="Редактор спільного FREE-пулу на телефоні з окремими Undo та збереженням">
